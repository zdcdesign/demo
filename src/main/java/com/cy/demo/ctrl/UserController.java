...
public class UserController {
    ...
    @ApiOperation(value = "获取附近的人")
    @ResponseBody
    @RequestMapping(value = "/getAroundStudent", method = RequestMethod.POST)
    public RestResponse getAroundStudent(@RequestBody UserPositionDto userPositionDto) {

        return iUserService.getAroundStudent(userPositionDto);
    }

    @ApiOperation(value = "获取附近的人")
    @ResponseBody
    @RequestMapping(value = "/getUserById", method = RequestMethod.POST)
    public RestResponse getUserById(@RequestBody IdReqDto idReqDto) {

        return iUserService.getUserById(idReqDto);
    }
